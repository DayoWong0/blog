...
![./image-20201101010101842](img/blibili/./image-20201101010101842.png)
...
![./image-20201101010132720](img/blibili/./image-20201101010132720.png)
...
![./image-20201101010150208](img/blibili/./image-20201101010150208.png)
...
- 4
  ...
  ![./image-20201101012738436](img/blibili/./image-20201101012738436.png)

  ```javascript
  document.querySelectorAll(".list-box li")[0].innerText;
  ```

  ![./image-20201101012851680](img/blibili/./image-20201101012851680.png)

  ```javascript
  document.querySelectorAll(".list-box li")[0].textContent;
  ```

  ![./image-20201101012938317](img/blibili/./image-20201101012938317.png)
